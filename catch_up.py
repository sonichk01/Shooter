...
btn_smooth=QPushButton("Зглажування")  
btn_smooth_more=QPushButton("Більше зглажувати")  
btn_emboss=QPushButton("Стиснення")  
btn_find_edges=QPushButton("Знайти краї")  
  
btn_left = QPushButton("Повернути вліво")  
btn_right = QPushButton("Повернути вправо")  
...
row_tools_2.addWidget(btn_smooth_more)  
row_tools_2.addWidget(btn_find_edges)  
row_tools_2.addWidget(btn_emboss)  
...
row2.addLayout(col1, 160)  
row2.addLayout(col2, 240)  
win.setLayout(row)  
